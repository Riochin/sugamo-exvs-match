...
1. The Result Reveal System shall 全プレイヤーの勝利数・敗北数をスコアレコードから集計し、勝率（勝利数 ÷ 総試合数）降順で最終順位を算出する
2. When 複数プレイヤーの勝率が同一である, the Result Reveal System shall 勝利数を二次ソートキーとして適用する
